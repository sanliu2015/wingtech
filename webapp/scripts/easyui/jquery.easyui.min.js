...
$("<option value='"+_a4.pageList[i]+"'></option>").text(_a4.pageList[i]).appendTo(ps);
}
...
var psop=ps[0];
for(var i=0;i<psop.options.length;i++){
	if(psop.options[i].value==_b6.pageSize){
		psop.options[i].selected = true;
		break;
	}
}
}
...
var opts=$(this).combobox("options");
return row[opts.textField].toLowerCase().indexOf(q.toLowerCase())>-1;// plq下拉框模糊搜索
