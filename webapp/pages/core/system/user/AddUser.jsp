...
<div style="padding:10px;padding-left:20%">
		<table cellpadding="0" cellspacing="0" class="baseForm-table">
            ...
            <tr  >
                <td  nowrap><label   for="bean.name">密码*</label></td>
           ...
           <td  nowrap><label   for="bean.securityLevel">用户类别</label></td>
				<td> <select name="bean.userLevel"  id="bean.userLevel" class="easyui-combobox"  data-options="editable:false"  style="width:180px;height:30px" > 
                                <ts:forEach name='userLevelList' value='-1' insertEmpty='0'/>
							</select></td>
            </tr> 
           <tr  >
           ...
           <tr  >
				...
				<td><input name="bean.companyIds"  id="bean.companyIds" class="easyui-textbox"   data-options='multiple:true,data:<ts:forEach name="companyList" toJson="1"/>'  style="width:400px;height:30px">
                  </td>
           </tr> 
           <tr  >
           ...
           <tr>
				<td nowrap><label  for="bean.isMenu">状态</label></td>
