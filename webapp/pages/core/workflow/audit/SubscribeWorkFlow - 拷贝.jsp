     ...
     <table cellpadding="0" cellspacing="0" class="baseForm-table" width="100%">
           ...
           <tr style="display:none">   	  
				...
				<tr   style="display:none" >  						 		 
                  ...
                  <input class="easyui-textbox" name="workFlowAuditLog.description" id="workFlowAuditLog.description" data-options="multiline:true" style="height:50px;width:500px"  value="已查阅"></input>  
      ...
      <a href="javascript:void(0)"  style="list-style:none;float:left;text-align:left" class="easyui-linkbutton"   data-options="iconCls:'icon-tip',plain:true"
   	...
   	<a href="javascript:void(0)" class="easyui-linkbutton" id="submitBtn" iconCls="icon-save"  onClick=" return workFlowAuditScript.submitForm(this);" >已查阅</a>
