		...
		<table cellpadding="0" cellspacing="0" class="baseForm-table">
			<tr  >
				<td nowrap><label id="number-label" for="summary.name">时间</label> 
				 <input name="summary.name"  id="summary.name"  class="easyui-textbox" readonly   style="width:180px;height:30px" value="${form.summary.name}" readonly></input>
                 </td> 
...
?number=${form.summary.fileName}&name=${form.summary.filePath}/${form.summary.saveToFileName}" onClick="">下载</a> </c:if>
           ...
           <td  nowrap colspan="2"><label   for="summary.eventExplain">标题*</label> 
				 <input name="summary.eventExplain"  id="summary.eventExplain"  readonly  class="easyui-textbox"     style="width:280px;height:30px" value="${form.summary.eventExplain}"></input></td>                 
            </tr> 
              <tr  >
