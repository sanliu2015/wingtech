...
?number=${form.summary.fileName}&name=${form.summary.filePath}/${form.summary.saveToFileName}" onClick="">下载</a> </c:if>
           ...
           <td  nowrap colspan="2"><label   for="summary.eventExplain">标题*</label> 
            ...
            <tr  > 
				<td   colspan="2" ><textarea   name="summary.description" id="bean.description"  style="height:400px;width:800px">${form.summary.description}</textarea></td>
			</tr>
		</table>
</div> 
 <div style="text-align:center;padding:5px; width:98%" class="dialog-button"> 
 			 <a href="javascript:void(0)" class="easyui-linkbutton" id="submitBtn" iconCls="icon-save"  onClick=" return myCalendarUtil.submitSummaryForm(this);">确定</a>  
