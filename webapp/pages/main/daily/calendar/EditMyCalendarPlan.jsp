		...
		<table cellpadding="0" cellspacing="0" class="baseForm-table">
           ...
           <td  nowrap><label   for="plan.eventExplain">计划事项*</label></td>
            ...
            <tr  >
				...
				<td><input name="plan.custName" id="plan.custName" class="easyui-textbox"    value="${form.plan.custName}"  style="width:180px;height:30px"  ></input></td>
           </tr>    
            <tr  >
                <td  nowrap><label   for="plan.place">地点 </label></td>
				<td><input name="plan.place" id="plan.place" class="easyui-textbox"  value="${form.plan.place}"   style="width:180px;height:30px"  ></input></td>
           </tr> 
			<tr  >
				<td nowrap><label   for="plan.description">详情</label></td>
				<td  ><input class="easyui-textbox" name="plan.description"    value="${form.plan.description}"  data-options="multiline:true" style="height:70px;width:300px"></input></td>
			</tr>
		</table>
</div> 
 <div style="text-align:center;padding:5px; width:98%" class="dialog-button"> 
             <a href="javascript:void(0)" class="easyui-linkbutton" id="submitBtn" iconCls="icon-tip"  onClick=" return myCalendarUtil.executeCalendarLog(this,'0');"   style="list-style:none;float:left;text-align:left">执行完成</a>  
