...
<div style="padding:10px;padding-left:20%"> 
        <table cellpadding="0" cellspacing="0" class="baseForm-table">
			<tr  >
             ...
             <tr  >
               <td  nowrap><label   for="log.planId">关联计划</label></td>
				<td> <select name="log.planId"  id="log.planId" class="easyui-combobox" value='${form.log.planId}'  data-options="editable:false"  style="width:180px;height:30px" > 
           ...
           <td  nowrap><label   for="log.summaryEvent">完成事项* </label></td>
				<td  > <input name="log.summaryEvent" id="log.summaryEvent" class="easyui-textbox"  value="${form.log.summaryEvent}"    style="width:180px;height:30px"  ></input></td>                 
            </tr> 
            <tr  >
                <td  nowrap><label   for="log.custName">拜访客户 </label></td>
				<td><input name="log.custName" id="log.custName" class="easyui-textbox" value="${form.log.custName}"      style="width:180px;height:30px"  ></input><a href="javascript:void(0)" class="easyui-linkbutton"  iconCls="icon-search" onClick="return myCalendarUtil.choseCust(this);">选择</a></td>
           </tr> 
            <tr  >
           ...
           <tr  >
            ...
            <tr  >
              <td nowrap align="left"><label id="number-label" for="log.file">上传附件</label> </td> 
               <td  >  <input type="file" name="log.file"    /> ${form.log.fileName}  &nbsp;&nbsp;
...
?number=${form.log.fileName}&name=${form.log.filePath}/${form.log.saveToFileName}" onClick="">下载</a> </c:if>
 ...
 <a href="javascript:void(0)" class="easyui-linkbutton" id="submitBtn" iconCls="icon-tip"  onClick=" return myCalendarUtil.openAddTravelFee(this );"   style="list-style:none;float:left;text-align:left">费用报销单</a> 
 			 <a href="javascript:void(0)" class="easyui-linkbutton" id="submitBtn" iconCls="icon-save"  onClick=" return myCalendarUtil.submitLogForm(this);">确定</a>  
