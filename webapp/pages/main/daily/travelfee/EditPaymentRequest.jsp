		 ...
		 onclick="tavelFeeScript.insertExplanatioRow(this)">添加</a></td>
                 ...
                 <tr cloneRowFlag="1"  style="display:none" >
                    ...
                    <td > <input   name='dtlList.eventTime' id='dtlList.eventTime'    style='width:85%'  class='easyui-my97' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  ></input> </td> 
                     <td   colspan="3"> <select name='dtlList.feeKindId' id='dtlList.feeKindId'   style='width:95%'   data-options="editable:false,valueField:'id',textField:'text'"/></select> </td> 
      ...
      <tr> 
             ...
             <table id="fileListGrid">
              <c:forEach items="${form.fileList}" var="file" varStatus="vs">
                ...
                onclick="$.ts.EasyUI.deleteTableRow(this)">删除</a><span id="fieldName" style="border:1px solid #03C; background:#FFC">${file.fileName}</span><input type="file" name="fileList.file"    style="display:none" />
