    ...
    <table   border="0" cellspacing="0" cellpadding="0"  width="100%"  align="center">
      ...
      <table   border="0"  cellspacing="0" cellpadding="0" width="100%"  id="dtlListGrid"   align="center" class="billTable" >
                ...
                <tr><td   > item No/项目编号 </td>
                 ...
                 <tr><td colspan="6">
                 Date of payment required/要求付款日期：<input  style="width:130px;"  name="bean.requiredPayDate" class="inputUnderLine"  readonly value="${form.bean.requiredPayDate}"></input>
                   </td> 
                 </tr>
