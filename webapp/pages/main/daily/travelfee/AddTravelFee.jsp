      ...
      <table   border="0"  cellspacing="0" cellpadding="0" width="100%"  id="dtlListGrid"   align="center" class="billTable" >
		 ...
		 onclick="tavelFeeScript.insertExplanatioRow(this)">添加</a></td>
                 ...
                 <tr cloneRowFlag="1"  style="display:none" >
                    ...
                    <td > <input   name='dtlList.eventTime' id='dtlList.eventTime'    style='width:85%'  class='easyui-my97' onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"    value="${appReqeustContext.currentDate}"></input> </td> 
                     <td   colspan="3"><select name='dtlList.description' id='dtlList.description'   style='width:95%'   data-options="valueField:'id',textField:'text'"/></select> </td> 
            ...
            <input name="dtlList.id"   type="hidden" />
                 ...
                 <tr><td colspan="6">
                 Date of payment required/要求付款日期：<input  style="width:100px;"  name="bean.requiredPayDate" class="inputUnderLine"  onfocus="WdatePicker({dateFmt:'yyyy-MM-dd'})"  ></input>
                   </td> 
                 </tr>
...
<script type="text/javascript" src="<ts:base ref='path'/>/TravelFee.js?version=1.1"></script> 
