...
<body id="${appReqeustContext.appKey}Body"   >  
 <form action="${contextPath}/main/companyService/json/save.do" id="${appReqeustContext.appKey}Form" name="${appReqeustContext.appKey}Form" method="post">  
...
<div style="padding:10px;padding-left:5%">
		<table cellpadding="0" cellspacing="0" class="baseForm-table">
           ...
           <tr  >
                <td  nowrap><label   for="bean.forShort">简称</label></td>
           ...
           <tr  >
				...
				<td><input name="bean.principal"  class="easyui-textbox"   style="width:150px;height:30px"   /></input><a href="javascript:void(0)" class="easyui-linkbutton"  plain='true' iconCls="icon-search" onClick="return companyScript.chooseEmployee(this);">选择</a>
           ...
           <tr  >
				...
				<td> <select name="bean.securityLevel"  id="bean.companyType" class="easyui-combobox"  data-options="editable:false" style="width:180px;height:30px" >   
                                <ts:forEach name='companyTypeList'/>
							</select></td>
           </tr> 
           <tr  >
           ...
           <tr  >  
			...
			<tr  >
				...
				<td   colspan="3"><input class="easyui-textbox" name="bean.description"   data-options="multiline:true" style="height:50px;width:400px"></input></td>
			</tr>
		</table>
</div> 
...
<script type="text/javascript" src="<ts:base ref='path'/>/Company.js?version=3.1"></script> 
