...
<body id="${appReqeustContext.appKey}Body"   >  
 <form action="${contextPath}/main/positionService/json/save.do" id="${appReqeustContext.appKey}Form" name="${appReqeustContext.appKey}Form" method="post">  
<div style="padding:10px;padding-left:20%">
		<table cellpadding="0" cellspacing="0" class="baseForm-table">
            ...
            <tr  >
                <td  nowrap><label   for="bean.parentName">上级职位称</label></td>
 ...
 <div style="text-align:center;padding:5px; width:98%" class="dialog-button"> 
            ...
            <a href="javascript:void(0)" id="backbtn" class="easyui-linkbutton" iconCls="icon-cancel"  onClick="$.ts.EasyUI.closeDialog(this,'0');">关闭</a>     
     </div> 
