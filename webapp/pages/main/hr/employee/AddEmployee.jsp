...
<body id="${appReqeustContext.appKey}Body"   >  
 <form action="${contextPath}/main/${appReqeustContext.appService}/json/save.do" id="${appReqeustContext.appKey}Form" name="${appReqeustContext.appKey}Form" method="post" enctype="multipart/form-data">  
...
<div style="padding:10px;padding-left:10px">
		<table cellpadding="0" cellspacing="0" class="baseForm-table">
            <tr  >
				...
				<td> <select name="bean.company.id"   id="bean.company.id"    data-options="editable:false" class="easyui-combobox"  style="width:180px;height:30px" >   
                                <ts:forEach name='companyList'/>
							</select></td>
                
                <td  nowrap><label   for="bean.dept.id">部门*</label></td>
				<td><input name="bean.dept.id" id="bean.dept.id"    class="easyui-textbox"  style="width:180px;height:30px"  /></input>  </td>
			...
			<tr  > 
			 ...
			 <tr  >
				...
				<td><input name="bean.idCard" id="bean.idCard" class="easyui-textbox"   style="width:180px;height:30px" data-options="onChange:employeeScript.idCardChangeEvent"/></input></td>
            ...
            <td  nowrap><label   for="bean.securityLevel">学历</label></td>
				<td  > <select name="bean.degree"  id="bean.degree" class="easyui-combobox"  style="width:180px;height:30px">   
                                <ts:forEach name='degreeList'  value=''/>
							</select></td>
                </tr> 
           <tr  >
           ...
           <tr  >
              <td  nowrap><label   for="bean.inDate">入司日期</label></td>
             ...
             <tr>
				...
				<td  > <select name="bean.employeeKind"  id="bean.employeeKind" class="easyui-combobox"  data-options="editable:false" style="width:180px;height:30px">   
