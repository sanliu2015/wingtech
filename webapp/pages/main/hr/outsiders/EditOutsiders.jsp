...
<body id="${appReqeustContext.appKey}Body">  
 <form action="${contextPath}/main/outsidersService/json/update.do" id="${appReqeustContext.appKey}Form" name="${appReqeustContext.appKey}Form" method="post"> 
   <input name="bean.id" type="hidden"  />
   <div id="${appReqeustContext.appKey}FormJson" style="display:none">${formJson}</div>
   <input name="actionType" id="actionType" type="hidden" value="update"/> 
...
<div style="text-align:center;padding:5px; width:98%" class="dialog-button"> 
	<a href="javascript:void(0)" class="easyui-linkbutton" id="submitBtn" iconCls="icon-save"  onClick=" return outsidersScript.submitForm(this);">确定</a>  
...
<script type="text/javascript">
	...
	$(function() {
		outsidersScript.initPage({appKey:"${appReqeustContext.appKey}"});
