...
function BlacklistScript(){  
	 this.appKey=""; 
	 this.opts=null;
 }
BlacklistScript.prototype={      
	...
	comboboxFormat:function(val, row, index) {
		...
		return  "<input class='easyui-combobox' type='text' name='dtlList."+fieldName+"' id='dtlList."+fieldName+"' value='" + val + "'  style='width:100%'    data-options='editable:false,valueField:\"value\",textField:\"text\",data:"+thingsScript[dataList]+"'/>";
	},
