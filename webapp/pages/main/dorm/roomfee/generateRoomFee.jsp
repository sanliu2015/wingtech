...
<form action="${contextPath}/main/${appReqeustContext.appService}/json/doGenerateRoomFee.do" id="${appReqeustContext.appKey}Form" name="${appReqeustContext.appKey}Form" method="post">  
	...
	<div id="pagePanel" class="easyui-panel dialog-button" width="100%" style="text-align:center;padding:5px;">
 		<a href="javascript:void(0)" class="easyui-linkbutton" id="submitBtn" iconCls="icon-save"  onClick=" return roomFeeScript.submitFormOnRoomFee(this);">确定</a>  
