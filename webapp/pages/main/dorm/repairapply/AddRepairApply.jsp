...
<input name="bean.id" type="hidden"  /><input name="bean.auditStatus" type="hidden" value="0" /><input name="bean.status" type="hidden" value="0" /> 
	...
	<div id="dtlListGridToolbar"  >
 	...
 	<div id="pagePanel" class="easyui-panel dialog-button" width="100%" style="text-align:center;padding:5px;">
 			 <a href="javascript:void(0)" class="easyui-linkbutton" id="submitBtn" iconCls="icon-save"  onClick=" return repairApplyScript.submitForm(this);">确定</a>  
...
<script type="text/javascript" src="<ts:base ref='path'/>/RepairApply.js?v170735"></script> 
<script type="text/javascript">
	...
	$(function() { 
	   repairApplyScript.initPage({ appKey:"${appReqeustContext.appKey}"});    
	    
	}); 
