		...
		<table cellpadding="0" cellspacing="0" class="baseForm-table" width="100%">
        	<tr>
		   	...
		   	<tr>
				...
				<td><input name="bean.leaveDate" id="bean.leaveDate" class="easyui-my97" style="width:126px;height:28px"   /></td>
				<td  nowrap><label   for="bean.leaveTime">离开时间</label></td>
				<td><input name="bean.leaveTime" id="bean.leaveTime" class="easyui-my97" style="width:126px;height:28px" onfocus="WdatePicker({dateFmt:'HH:MM:ss'})" /></td>
		   	</tr >
		   	<tr>
...
<script type="text/javascript">
	...
	function modalDialogLoadEvent() {
		...
		$('#${appReqeustContext.appKey}Form').find('input,textarea,select').attr('readonly',true);
	} 
</script>      
</form> 
</body>
