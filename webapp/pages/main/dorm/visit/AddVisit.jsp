...
<form action="${contextPath}/main/${appReqeustContext.appService}/json/save.do" id="${appReqeustContext.appKey}Form" name="${appReqeustContext.appKey}Form" method="post">  
	...
	<input name="bean.doorName" id="bean.doorName" type="hidden" value="${doorName}" />
        	...
        	<tr>
		   	...
		   	<tr>
				...
				<td>
			   	...
			   	<td ><input class="easyui-textbox" name="bean.visitorNum" id="bean.visitorNum" style="width:150px;height:30px" value="1" /></td> --%>
		   	</tr>
		   	<tr>
	...
	<div id="dtlListGridToolbar"  >
        <a href="javascript:void(0)" class="easyui-linkbutton" id="insertDtlRowId" data-options="iconCls:'icon-add',plain:true" onclick="visitScript.appendRow(this);">添加携带物品</a>
	</div> 
