...
<body id="${appReqeustContext.appKey}Body"   > 
 <form action="${contextPath}/main/knowledgeTypeService/json/save.do" id="${appReqeustContext.appKey}Form" name="${appReqeustContext.appKey}Form" method="post"> 
   <input name="knowType.id" type="hidden"  />  
...
<div style="padding:10px;padding-left:20%">
		<table cellpadding="0" cellspacing="0" class="baseForm-table">
            <tr  >
				...
				<td><input name="knowType.typeName" id="knowType.typeName" class="easyui-textbox"   value="" style="width:180px;height:30px"  /></input></td>
           </tr>
           <tr> 
           ...
           <tr>
			...
			<tr  >
				...
				<td  ><input class="easyui-textbox" name="knowType.description"   data-options="multiline:true" style="height:50px;width:300px"></input></td>
			</tr>
		</table>
</div> 
