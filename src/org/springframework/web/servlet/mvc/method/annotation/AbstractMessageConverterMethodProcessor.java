...
public abstract class AbstractMessageConverterMethodProcessor extends AbstractMessageConverterMethodArgumentResolver
	...
	protected <T> void writeWithMessageConverters(T returnValue, MethodParameter returnType, NativeWebRequest webRequest)
		...
		/*if( returnValue!=null &&  Void.class.isAssignableFrom(returnValue.getClass() )==false && 
				ReflectUtils.existPropertyOfBean(returnValue, "needWriteResponse")){
			String needWriteResponse=(String)ReflectUtils.getFieldValue(returnValue, "needWriteResponse");
			if("1".equals(needWriteResponse)) return;
		}*/
