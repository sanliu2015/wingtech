...
public abstract class BeanUtils {
	...
	public static void copyNoNullProperties(Object source, Object target) throws BeansException {
		copyNoNullProperties(source, target, null, null,(String[]) null);
	}
	public static void copyNoNullProperties(Object source, Object target,String ignoreListNullFields) throws BeansException {
		copyNoNullProperties(source, target, null, ignoreListNullFields,(String[]) null);
	}
	private static void copyNoNullProperties(Object source, Object target, Class<?> editable,  String ignoreListNullFields,String... ignoreProperties)
			throws BeansException {
		...
		if(ignoreListNullFields!=null)
			nullFields=ignoreListNullFields.split(",");
		for (PropertyDescriptor targetPd : targetPds) {
			Method writeMethod = targetPd.getWriteMethod();
			if (writeMethod != null && (ignoreProperties == null || (!ignoreList.contains(targetPd.getName())))) {
				PropertyDescriptor sourcePd = getPropertyDescriptor(source.getClass(), targetPd.getName());
					...
					if (readMethod != null &&
						...
						try {
							...
							if(value!=null){
								...
								if(nullFields!=null){
									for(int s=0;s<nullFields.length;s++){
										if(nullFields[s].equals(targetPd.getName())){
											if (!Modifier.isPublic(writeMethod.getDeclaringClass().getModifiers())) {
												writeMethod.setAccessible(true);
											}
											writeMethod.invoke(target, value);
