...
public class TestEventPullSources {
	public static Map<String,Event> msgMap=new HashMap<String,Event>();
  ...
  static public class TemperatureEventPullSource extends EventPullSource {
    ...
    public long getSleepTime() {
        return Rand.randomLong(3000, 6000);
    	//return 1000;
    }

    public Event pullEvent() {
    	return  Event.createDataEvent("/ts");
    	/*if(msgMap.size()<=0) return  Event.createDataEvent("/ts");
    	Object[] arr=msgMap.keySet().toArray();
    	String key=(String)arr[0];
    	Event e=msgMap.get(key);
    	msgMap.remove(key);
    	return e;*/
